...
class ResPartner(models.Model):
    ...
    def send_msg(self):
        ...
        cre_id = self.env['ir.config_parameter'].sudo().get_param('whatsapp_dyn.select_account_whatsapp')
        ...
        try:
            ...
            for order in self:
                ...
                signature_check = self.env['ir.config_parameter'].sudo().get_param(
                    'whatsapp_dyn.whatsapp_signature')
...
class BoxSettings(models.Model):
    ...
    def get_qr_code(self):
        ...
        # self.image = str(base64.b64encode(response.content))

        partner = self.env['whatsapp.settings'].create({
