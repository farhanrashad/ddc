...
odoo.define('de_pos_stock_info.pos', function(require) {
    "use strict";
    ...
    models.load_models([{
		...
		loaded: function(self,result) {
			self.db.product_stock_by_location = {};
			result.forEach(element => {
				self.db.product_stock_by_location[element.id] = element;
			});
		}
...
// Start PosStockWidget
    
    var PosStockWidget = screens.ActionButtonWidget.extend({
        template: 'PosStockWidget',
        ...
        renderElement: function(){
            ...
            this.$el.click(function(){
                ...
                if (self.pos.db.get_product_by_category(self.pos.config.pos_bag_category_id[0]).length == 1) { 
                    ...
                    self.gui.show_popup('pos_stock_popup_widget', {'orderlines': orderlines});
                }
    ...
    screens.define_action_button({
        'name': 'Pos Stock Widget',
        'widget': PosStockWidget,
        'condition': function() {
            return true;
        },
    });
    ...
    // ProductStockPopupWidget Popup start

    var ProductStockPopupWidget = popups.extend({
        template: 'ProductStockPopupWidget',
    ...
    gui.define_popup({
        name: 'pos_stock_popup_widget',
        widget: ProductStockPopupWidget
    });
