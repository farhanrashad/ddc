...
var MultiUomWidget1 = PosBaseWidget.extend({
    template: 'MultiUomWidget1',
    ...
    show: function(options){
        ...
        this.product_stock_list[0] = 'helo1';
        this.product_stock_list[1] = 'helo2';
        this.product_stock_list[2] = 'helo3';
...
gui.define_popup({name:'multi_uom_screen', widget: MultiUomWidget1});
